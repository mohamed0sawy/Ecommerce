package com.academy.Ecommerce.filter;

import com.academy.Ecommerce.dto.ErrorDto;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        // Print the authenticated user details
        System.out.println("AUTHENTICATED_USER: " + authentication);

        // Print the user's authorities/roles
        if (authentication != null) {
            System.out.println("USER_ROLES: " + authentication.getAuthorities());
        }
        filterChain.doFilter(request, response);
    }
